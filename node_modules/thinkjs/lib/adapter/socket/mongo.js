...
var _default = (function (_think$adapter$socket) {
  _inherits(_default, _think$adapter$socket);

  function _default() {
    _classCallCheck(this, _default);

    _think$adapter$socket.apply(this, arguments);
  }
  ...
  _default.prototype.init = function init(config) {
    _think$adapter$socket.prototype.init.call(this, config);
