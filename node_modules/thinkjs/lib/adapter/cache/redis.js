...
var _default = (function (_think$adapter$cache) {
  ...
  _default.prototype.init = function init() {
    ...
    var instance = thinkCache(thinkCache.REDIS, key);
    if (!instance) {
  ...
  _default.prototype.get = function get(name) {
    return this.redis.get(this.keyPrefix + name).then(function (value) {
      if (value) {
  ...
  _default.prototype.set = function set(name, value) {
    ...
    return this.redis.set(this.keyPrefix + name, JSON.stringify(value), timeout)['catch'](function () {});
  };
  ...
  _default.prototype['delete'] = function _delete(name) {
    return this.redis['delete'](this.keyPrefix + name)['catch'](function () {});
  };
