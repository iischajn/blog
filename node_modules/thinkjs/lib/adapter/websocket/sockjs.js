...
var _default = (function (_think$adapter$websocket) {
  _inherits(_default, _think$adapter$websocket);

  function _default() {
    _classCallCheck(this, _default);

    _think$adapter$websocket.apply(this, arguments);
  }
