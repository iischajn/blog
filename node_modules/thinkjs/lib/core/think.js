...
think.middleware = function () {
  ...
  if (length >= 2 && think.isHttp(methods)) {
    ...
    if (think.isString(_name2)) {
      ...
      return think.co.wrap(_name2)(http, data);
    }
  }
  // get middleware
  ...
  paths.forEach(function (path) {
    if (type) {
      ...
      dirs.forEach(function (dir) {
        ...
        var cls = think.require('adapter_' + dir + '_base', true);
        if (cls) {
...
think.session = function (http) {
  ...
  var Cookie = thinkCache(thinkCache.COLLECTION, 'cookie');
  if (!Cookie) {
  ...
  var type = sessionOptions.type || 'base';
  if (type === 'base') {
  ...
  var conf = think.extend({}, sessionOptions, { cookie: sessionCookie });
  ...
  return _regeneratorRuntime.async(function callee$0$0$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        ...
        Cls = think.adapter('cache', options.type || 'base');
      ...
      case 17:
        context$1$0.next = 19;
        return _regeneratorRuntime.awrap(think.co.wrap(value)(name));
...
think.validate = function (name, callback) {
  ...
  var _loop = function (_name3) {
    ...
    if (item.value === '' || item.value === undefined || item.value === null) {
      if (item.required) {
        msg[_name3] = getMsg('required', _name3, item.value, []);
      }
      return 'continue';
    }
...
think.npm = function (pkg) {
  try {
    ...
    var _ret3 = (function () {
      ...
      var cmd = 'npm install ' + pkgWithVersion;
      return {
